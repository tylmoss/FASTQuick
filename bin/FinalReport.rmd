...
#ancestry
alphaScale=scale_alpha_discrete(range = c(0.9,0.3), guide = "none")
sizeScale=scale_size(range=c(1.5,1), guide = "none")
...
## Summary Plot
```{r Misc, fig.align = "center", warning=FALSE}
